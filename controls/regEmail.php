...
$message = '<html>
                    <body style="margin: 0 auto; padding: 10px; border: 1px solid #e1e1e1; font-family:Calibri">
                        ...
                        Your user account has been successfully created. You can create your own MRF Account at <a link="www.innogroup.com.ph/mrf">www.innogroup.com.ph/mrf</a>. Sign in by using the username <b>' . str_replace(" ", "", $username) . '</b> and password of <b>123456</b> to access the system.<br>Please immediately change your password as directed.<br><br>
                        Thank you. <br><br>
                        ...
                        <div style="padding:10px 0px; text-align: center; font-size: 11px; border-top: 1px solid #e1e1e1">
                         MATERIAL REQUISITION FORM &middot; <a href="http://www.innogroup.com.ph/mrf">Innogroup</a>
                        </div>
                    </body>
                </html>';
